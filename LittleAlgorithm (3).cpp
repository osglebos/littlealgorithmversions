...
int **Inicialize(void)
{
	int tmp[ARRAY_SIZE][ARRAY_SIZE] = {
		{-1, 1, 2, 3, 4, 5, 6, 7},
		{1, MAX_INF, 65, MIN_INF, MIN_INF, MIN_INF, MIN_INF, 10},
		{2, 65, MAX_INF, 45, 15, MIN_INF, MIN_INF, MIN_INF},
		{3, MIN_INF, 45, MAX_INF, 53, MIN_INF, 50, 42},
		{4, MIN_INF, 15, 53, MAX_INF, 55, 61, MIN_INF},
		{5, MIN_INF, MIN_INF, MIN_INF, 55, MAX_INF, 87, MIN_INF},
		{6, MIN_INF, MIN_INF, 50, 61, 87, MAX_INF, 73},
		{7, 10, MIN_INF, 42, MIN_INF, MIN_INF, 73, MAX_INF}
	};

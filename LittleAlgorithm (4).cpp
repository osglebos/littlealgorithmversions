...
int **Inicialize(void)
{
	int tmp[ARRAY_SIZE][ARRAY_SIZE] = {
		{-1, 1, 2, 3, 4, 5, 6, 7},
		{1, MAX_INF, 65, MIN_INF, MIN_INF, MIN_INF, MIN_INF, 34},
		{2, 65, MAX_INF, 45, 53, MIN_INF, MIN_INF, MIN_INF},
		{3, MIN_INF, 45, MAX_INF, 53, MIN_INF, 50, 24},
		{4, MIN_INF, 53, 53, MAX_INF, 55, 16, MIN_INF},
		{5, MIN_INF, MIN_INF, MIN_INF, 55, MAX_INF, 45, MIN_INF},
		{6, MIN_INF, MIN_INF, 50, 16, 45, MAX_INF, 37},
		{7, 34, MIN_INF, 24, MIN_INF, MIN_INF, 37, MAX_INF}
	};
